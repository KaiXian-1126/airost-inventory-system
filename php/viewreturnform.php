...
$returnamount = $result_row['ReturnAmount'];
$lossamount = $result_row['ItemLoss'];
$lossreason = $result_row['LossReason'];
$validreturndate = $result_row['ReturnDate'];
...
<body>
    ...
    <div class="form">
        ...
        <h2>Approved Return Inventory Form</h2>
        <form method="POST" action="returninventoryform.php" onsubmit="return returnFormValidation();">
            <div class="grid_container">
                ...
                <input type="number" class="returnamount" name="returnamount" value="<?php echo $returnamount; ?>" readonly>

                <p class="loss">Loss amount</p>
                <input type="number" class="loss" name="loss" value="<?php echo $lossamount; ?>" readonly>

                <p class="lossreason">Item loss reason:</p>
                <textarea cols="30" rows="5" name="lossreason" class="lossreason" readonly><?php echo $lossreason; ?></textarea>

                <p class="date">Date validate return form:</p>
                <input type="text" class="date" name="date" value="<?php echo $validreturndate; ?>" readonly>
            </div>
        </form>
    </div>
</body>
